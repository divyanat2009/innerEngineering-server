...
describe(`Inner Engineering endpoints`,()=>{
    let db; 
    ...
    before('clean the table', () => db.raw('TRUNCATE ie_gratitudes, ie_users RESTART IDENTITY CASCADE'));

    afterEach('cleanup',() => db.raw('TRUNCATE ie_gratitudes, ie_users RESTART IDENTITY CASCADE'));
